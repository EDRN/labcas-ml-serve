...
"""
todo:
How to share the same model in ray for multiple requests? Is this a good practice?
How to add CPU resources to each function?
How to add the following documentations based on an external file:
- deprecated
- input examples
- endpoint descriptions
Be able to read and write to Labcas
